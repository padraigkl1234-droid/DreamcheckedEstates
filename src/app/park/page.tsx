...
import { ArrowLeft, ClipboardList, Link as LinkIcon } from "lucide-react";
import Link from "next/link";
import { useRouter } from "next/navigation";

export default function ParkChecklistsPage() {
        ...
        <div className="w-full max-w-4xl space-y-8">
            <div className="mb-8 flex flex-col items-center gap-2 text-center">
              ...
              <p className="max-w-md text-base text-muted-foreground sm:text-lg">
                Checklists for park operations.
              </p>
            </div>
              ...
              <Card className="transform-gpu transition-transform duration-300 hover:scale-105 hover:shadow-lg hover:shadow-primary/20 w-full max-w-md">
                <CardHeader>
                  <CardTitle className="flex items-center gap-3 text-xl">
                    ...
                    Park Operations Control Opening Checks
                  </CardTitle>
                </CardHeader>
                <CardContent>
                  <Button asChild>
                    <Link href="https://forms.office.com/Pages/ResponsePage.aspx?id=mfoYGzQzY0iReafbLftttfmhIWgCpdxOr6oOIUXc-xtURUlKU1k2NDNYSUs0WTZFRUdDMDVVTlk3Si4u" target="_blank" rel="noopener noreferrer">
                      Open Checklist
                    </Link>
                  </Button>
                </CardContent>
