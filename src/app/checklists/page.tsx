...
const CHECKLIST_SECTIONS: ChecklistSection[] = [
  {
    ...
    forms: [
      ...
      {
        name: 'Show Close — Post-Show',
        description: 'Post-show make-safe, housekeeping and handover after the Scenic Stage show.',
      ...
      {
        name: 'Scenic Stage Show — Checklist 3',
        description: 'Rename pending — tell me the form name and a one-line description.',
      ...
      {
        name: 'Scenic Stage Show — Checklist 4',
        description: 'Rename pending — tell me the form name and a one-line description.',
      ...
      {
        name: 'Scenic Stage Show — Checklist 5',
        description: 'Rename pending — tell me the form name and a one-line description.',
      ...
      {
        name: 'Scenic Stage Show — Checklist 6',
        description: 'Rename pending — tell me the form name and a one-line description.',
